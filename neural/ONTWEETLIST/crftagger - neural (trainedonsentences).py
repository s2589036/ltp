...
def main():
    ...
    X_train = bigsentencelist #the words of the sentencelist
    y_train = bigtaglistsentences #the tags of the sentencelist

    X_test = bigtweetlist #the words of the tweets
    y_test = bigtaglisttweets #the tags of the tweets
